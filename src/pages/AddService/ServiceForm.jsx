...
const ServiceForm = () => {
    return (
        <div className="mt-20 mb-14 bg-[#F3F3F3] rounded-lg flex justify-center items-center py-20">
            {/* service form */}
            <div className="sign_up_form card shrink-0 w-full sm:max-w-1/2 md:max-w-[85%] shadow-xl bg-base-100 py-10 rounded-lg">
