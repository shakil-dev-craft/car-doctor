    ...
    return (
        <div className="flex flex-col-reverse md:flex-row md:flex-none md:gap-12 lg:gap-24 my-24">
            <div className="relative md:w-[40%] lg:w-[50%]">
                <img className=' max-w-[100%] lg:max-w-[90%] md:min-h-[90%] lg:min-h-[95%] rounded-md object-fill' src={person} alt="" />
                <img className=' absolute md:-right-6 lg:right-0 md:-bottom-4 lg:-bottom-10 border-8 border-white rounded-md shadow-lg right-0 max-w-[50%]' src={parts} alt="" />
            </div>
            <div className='space-y-5 xl:pr-48 md:w-[60%] lg:w-[50%]'>
                <p className='text-5 font-bold text-[#FF3811]'>About Us</p>
                <h2 className='text-[45px] font-bold leading-none'>We are qualified & of experience in this field</h2>
