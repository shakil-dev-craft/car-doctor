    ...
    return (
        <Slider className='my-10' {...settings}>
            <div className='relative'>
                ...
                <div className=' px-5 md:px-14 lg:px-16 xl:px-24 flex flex-col justify-center text-white bg-gradient-to-r from-[#151515] to-transparent absolute top-0 left-0 w-full h-full rounded-lg'>
                  <div className=' md:space-y-5 lg:space-y-6 w-full sm:w-3/5 lg:w-2/5'>
